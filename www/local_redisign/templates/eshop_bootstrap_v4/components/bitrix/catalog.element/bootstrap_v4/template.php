...
// Delegate rendering to the stock Bitrix template, wrapped in our premium shell.
$templateFolder = '/bitrix/components/bitrix/catalog.element/templates/bootstrap_v4';
?>
<div class="mf-product-detail-shell">
	<?php include($_SERVER['DOCUMENT_ROOT'] . $templateFolder . '/template.php'); ?>
</div>
<?php
