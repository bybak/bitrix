...
$mfMenuMaxLevel = (int)($arParams["MAX_LEVEL"] ?? 1);
// Штатный bootstrap_v4 обходит ВСЕ разделы каталога и дергает CFile на каждый — нужно только для многоуровневого «мегаменю».
if ($mfMenuMaxLevel > 1 && IsModuleInstalled("iblock")) {
	$arFilter = array(
		"TYPE" => "catalog",
		"SITE_ID" => SITE_ID,
		"ACTIVE" => "Y",
