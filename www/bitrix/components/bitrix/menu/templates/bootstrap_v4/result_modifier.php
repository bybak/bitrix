...
$mfMenuBootstrapMaxLevel = (int)($arParams["MAX_LEVEL"] ?? 1);
// Полный обход разделов каталога + CFile на каждый — только для многоуровневого мегаменю (MAX_LEVEL > 1).
if ($mfMenuBootstrapMaxLevel > 1 && IsModuleInstalled("iblock"))
{
	$arFilter = array(
		"TYPE" => "catalog",
		"SITE_ID" => SITE_ID,
