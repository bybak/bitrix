...
<div class="mf-payment mf-text-page user-inner mb-4">
	...
	<div class="mf-payment-grid">
		<section class="mf-payment-card">
			<div class="mf-payment-card-head">
				<div class="mf-payment-icon" aria-hidden="true">
		...
		<section class="mf-payment-card">
			<div class="mf-payment-card-head">
				<div class="mf-payment-icon" aria-hidden="true">
					<svg viewBox="0 0 24 24" fill="none">
						<path d="M4 7h16a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/>
						<path d="M2 11h20" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
		...
		<section class="mf-payment-card">
			<div class="mf-payment-card-head">
				<div class="mf-payment-icon" aria-hidden="true">
					<svg viewBox="0 0 24 24" fill="none">
						<path d="M4 10V7a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v3" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
						<path d="M4 10h16v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-8Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/>
		...
		<section class="mf-payment-card">
			<div class="mf-payment-card-head">
				<div class="mf-payment-icon" aria-hidden="true">
					<svg viewBox="0 0 24 24" fill="none">
						<path d="M7 7h14v10a2 2 0 0 1-2 2H7V7Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/>
						<path d="M3 12h4" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
						<path d="M3 9h4" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
						<path d="M3 15h4" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
					</svg>
				</div>
